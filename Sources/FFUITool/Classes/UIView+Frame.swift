...
extension UIView {
    public func ffShadow(color: UIColor = UIColor.black.dynamicWhite.withAlphaComponent(0.5), offSet: CGSize = CGSize(width: 0, height: 0), radius: CGFloat = 5, path: CGPath? = nil) {
