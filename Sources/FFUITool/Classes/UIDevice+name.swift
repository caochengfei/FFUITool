...
//  FFUITool
//
//  Created by cofey on 2022/11/16.
//
...
public extension UIDevice {
    @objc static var deviceName: String {
        ...
        let identifier = matchMirror.children.reduce("") { identifier, element in
        ...
        case "iPad16,1" : return "iPad mini 7 WI-FI"
        case "iPad16,2": return "iPad mini 7 Cellular"
